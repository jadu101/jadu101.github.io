...
![lol it didn't load](images/discountvmprotect_11.png)
![lol it didn't load](images/discountvmprotect_12.png)
...
We can see many of the bytes are starting in 3 (i.e. 0x32, 0x36, 0x33 etc.)
