---
title: a-Attack Wordpress xmlrpc.php
draft: false
tags:
  - xmlrpc
---
...
How did the above identified the correct method to call (_system.listMethods_)? We did that by going through the well-documented [Wordpress code](https://codex.wordpress.org/XML-RPC/system.listMethods) and interacting with `xmlrpc.php`, as follows.

```shell-session
jadu101@htb[/htb]$ curl -s -X POST -d "<methodCall><methodName>system.listMethods</methodName></methodCall>" http://blog.inlanefreight.com/xmlrpc.php
